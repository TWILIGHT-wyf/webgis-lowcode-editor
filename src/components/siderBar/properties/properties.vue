            ...
            <div class="form-grid-2">
              <el-form-item label="宽度">
                <el-input-number
                  ...
                  @update:model-value="
                    (val: number | undefined) => setCanvasSize(val ?? canvasWidth, canvasHeight)
                  "
                  :min="100"
                  :max="10000"
                  :controls="false"
              ...
              <el-form-item label="高度">
                <el-input-number
                  ...
                  @update:model-value="
                    (val: number | undefined) => setCanvasSize(canvasWidth, val ?? canvasHeight)
                  "
                  :min="100"
                  :max="10000"
                  :controls="false"
                  ...
                  <template v-for="field in styleSchema" :key="field.key">
                    <el-form-item :label="field.label">
                      <el-input
                        ...
                        @update:model-value="
                          (val: string) => {
                            getStyleValue(field.key).value = val
                  ...
                  <el-form-item :label="field.label">
                    <template v-if="field.type === 'text' && selectComponent.dataSource">
                      ...
                      <el-input
                        ...
                        @update:model-value="
                          (val: string) => {
                            if (selectComponent?.dataSource) {
                              selectComponent.dataSource[field.key] = val
                              storeComponent.commitDebounced()
                            }
                          }
                        "
                    ...
                    <el-select
                      ...
                      :model-value="
                        selectComponent!.dataSource![field.key] as string | number | boolean
                      "
                      @update:model-value="
                        (val: string | number | boolean) => {
                          if (selectComponent?.dataSource) {
                    ...
                    <div v-else-if="field.type === 'color'" class="color-picker-row">
                      <el-color-picker
                        ...
                        @update:model-value="
                          (val: string | null) => {
                            if (selectComponent) {
                              selectComponent.props[field.key] = val
                              storeComponent.commitDebounced()
                            }
                          }
                        "
          ...
          <div v-if="selectComponent.type === 'Text'" class="text-content-section">
            ...
            <el-input
              ...
              @update:model-value="
                (val: string) => {
                  if (selectComponent) {
                    selectComponent.props.text = val
                    storeComponent.commitDebounced()
                  }
                }
              "
