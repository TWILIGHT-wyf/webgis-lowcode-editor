...
export const dashboardTemplate: PageTemplate = {
  ...
  components: [
    ...
    // 表格 - 底部
    {
      ...
      props: {
        columns: [
          { prop: 'time', label: '时间', width: 120, align: 'center' },
          { prop: 'user', label: '用户', width: 150, align: 'left' },
          { prop: 'action', label: '操作', width: 200, align: 'left' },
          { prop: 'status', label: '状态', width: 100, align: 'center' },
        ],
        data: [
          { time: '14:32:10', user: '用户A', action: '登录系统', status: '成功' },
          { time: '14:31:45', user: '用户B', action: '查看报表', status: '成功' },
          { time: '14:30:22', user: '用户C', action: '数据导出', status: '进行中' },
          { time: '14:29:58', user: '用户D', action: '修改配置', status: '成功' },
        ],
        stripe: true,
        border: true,
      },
